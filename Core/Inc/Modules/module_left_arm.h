 ...
 *  FilePath     : module_left_arm.h
 *  Description  : 左机械臂DM电机双环PID位置控制模块
 *  LastEditors  : Polaris
 *  Date         : 2024-0x-0x
 *  LastEditTime : 2024-0x-0x
 */
#ifndef __MODULE_LEFT_ARM_H__
#define __MODULE_LEFT_ARM_H__
...
//extern Motor_ControlCmd_t motor_ctrl_cmd[];
...
void LeftArm_Output(void);

#ifdef __cplusplus
}
#endif

#endif /* __MODULE_LEFT_ARM_H__ */